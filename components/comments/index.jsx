    ...
    <div className="comments-list">
        ...
        <div className="comments-text">
          <div className="user-info">
            ...
            <div className="user-texts">
              <h4 className="name-surname">- burada ismi olacak -</h4>
              <h4 className="user-name">- burada kullanıcı adı olacak -</h4>
            </div>

            <button className="reply-button" onClick={handleReplyChange}>
              Reply
            </button>
          </div>
          ...
          <form
            ...
            style={{ display: replyOpen ? "flex" : "none" }}
          >
            <textarea
              name="post-comments"
              id="post-comments"
      ...
      {/* 
        <div className="comments-text">
            ...
            <p>
                <span>@hummingbird1</span> While waiting for dark mode, there are
                browser extensions that will also do the job. Search for "dark
                theme” followed by your browser. There might be a need to turn off
                the extension for sites with naturally black backgrounds though.
            </p>
            </div>
        </div>
